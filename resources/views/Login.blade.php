...
<head>
 ...
 <!-- Theme style -->
  <link rel="stylesheet" href="{{URL('AdminPanel/dist/css/AdminLTE.min.css')}}"> <!-- iCheck -->
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    {!!Form::open(['url'=>'do-login','method'=>'post'])!!}
     
      <div class="form-group has-feedback">
        
        {!!Form::label('email','Username') !!} <span style="color:red;">*</span>
        {!!Form::text('email',null,['class' => 'form-control','placeholder' => 'Please enter email','required' => 'required']) !!}

      </div>
      <div class="form-group has-feedback">
        {!!Form::label('password','Password') !!} <span style="color:red;">*</span>
        {!!Form::password('password',['class' => 'form-control','placeholder' => 'Please enter password','required' => 'required']) !!}
...
<!-- iCheck -->
<script src="{{URL('AdminPanel/plugins/iCheck/icheck.min.js') }}"></script>
<script>
  $(function () {
    $('input').iCheck({
